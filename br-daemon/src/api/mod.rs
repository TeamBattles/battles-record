...
use crate::extension::connection::ConnectionInfo;
use crate::extension::pairing::PairingManager;
use crate::extension::protocol::DaemonMessage;
...
pub struct AppState {
    ...
    pub pairing_manager: Arc<tokio::sync::RwLock<PairingManager>>,
    pub extension_connections: Arc<tokio::sync::RwLock<HashMap<Uuid, ConnectionInfo>>>,
    pub extension_message_senders: Arc<tokio::sync::RwLock<HashMap<Uuid, mpsc::Sender<DaemonMessage>>>>,
    pub extension_shutdown_tx: Option<mpsc::Sender<()>>,
