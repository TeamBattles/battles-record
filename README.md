...
services:
  battles-record:
    ...
    volumes:
      ...
      # Processed files and Jellyfin library
      - ./library:/data/library
      # Channel profile/banner images
      - ./images:/data/images
      # Config storage (persists across restarts)
      - ./config:/config
    environment:
...
└── twitch/
    └── shroud/
        ...
        ├── logo.png
        └── Season 02/
            ├── shroud - S02E001 - Valorant Ranked.mp4
            ├── shroud - S02E001 - Valorant Ranked.nfo
            └── shroud - S02E001 - Valorant Ranked-thumb.jpg
```

**Season numbering:** S01 = January, S02 = February, ... S12 = December
